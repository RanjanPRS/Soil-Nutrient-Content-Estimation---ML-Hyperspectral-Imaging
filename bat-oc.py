...
file_path = '/home/user/Documents/FYP/SPLIT_N_P_K_LOW_MEDIUM_HIGH.xlsx'  # Replace with your file path
...
sheet_name = 'SPLIT_N_P_K_LOW_MEDIUM_HIGH'  # Update if incorrect
